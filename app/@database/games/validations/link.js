  ...
  try {
    ...
    if (!Array.isArray(valueArr)) {
      throw new CustomError({
        level: "warn",
        errorsArr: [{ code: "NElPzjH5D", messageID: "qnWsuPcrJ" }],
      });
    }
    ...
    if (valueArr.length > limit) {
      throw new CustomError({
        level: "warn",
        errorsArr: [{ code: "4slY0VPkF", messageID: "qnWsuPcrJ" }],
      });
    }
    ...
    if (valueArr.length === 0) {
      if (required) {
        throw new CustomError({
          level: "warn",
          errorsArr: [{ code: "qKCsFT0ao", messageID: "cFbXmuFVh" }],
        });
      }
